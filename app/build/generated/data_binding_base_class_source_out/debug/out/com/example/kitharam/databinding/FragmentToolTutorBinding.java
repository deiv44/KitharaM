...
public final class FragmentToolTutorBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentToolTutorBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static FragmentToolTutorBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentToolTutorBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_tool_tutor, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentToolTutorBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentToolTutorBinding((RelativeLayout) rootView, startStopButton, tempoLabel,
          tempoSeekBar);
    }
