...
public final class ActivityForgotPassBinding implements ViewBinding {
  ...
  @NonNull
  public final FrameLayout forgotFragmentContainer;

  private ActivityForgotPassBinding(@NonNull FrameLayout rootView,
      @NonNull FrameLayout forgotFragmentContainer) {
    this.rootView = rootView;
    this.forgotFragmentContainer = forgotFragmentContainer;
  }
  ...
  public static ActivityForgotPassBinding bind(@NonNull View rootView) {
    ...
    FrameLayout forgotFragmentContainer = (FrameLayout) rootView;

    return new ActivityForgotPassBinding((FrameLayout) rootView, forgotFragmentContainer);
  }
}
